...
namespace BlazorAppFörstaTest.Server.Services;
...
public class AuthService : IAuthService
{
	...
	private bool VerifyPasswordHash(string password, byte[] userPassworHash, byte[] userPasswordSalt)
	{
		using (var hmac = new HMACSHA512(userPasswordSalt))
		{
			var computedHash = hmac.ComputeHash(System.Text.Encoding.UTF8.GetBytes(password));
			return computedHash.SequenceEqual(userPassworHash);
		}
	}
